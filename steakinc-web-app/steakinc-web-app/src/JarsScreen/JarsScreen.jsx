...
function JarScreen() {
    ...
    const fetchJarTransactions = async (jarId) => {
        try {
            const response = await axios.get(`https://plasma-torus-454810-h1.lm.r.appspot.com/user_jar_transactions/${userId}/${jarId}`);
    ...
    const handleEditJar = async () => {
        ...
        try {
            const response = await axios.put(`https://plasma-torus-454810-h1.lm.r.appspot.com/update_jar/${selectedJar.jar_id}`, {
